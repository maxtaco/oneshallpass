...
So your password will require 2^(65-59) or roughly $64 to crack.

If you want better security, you can choose a 5-word passphrase (i.e. 72 bits
of entropy), which conservatively costs about $1 million to crack.
